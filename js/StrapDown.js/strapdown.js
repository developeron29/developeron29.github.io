...
;(function(window, document) {
  ...
  newNode.className = 'navbar navbar-expand-lg bg-primary text-light';
  if (!navbarEl && titleEl) {
    newNode.innerHTML = '<div class="container-fluid"> <a  href="javascript:void(0)" id="headline" class="navbar-brand text-light"> </a></div>';
